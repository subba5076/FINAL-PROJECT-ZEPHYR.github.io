...
<body>
<div class="m">
    <div class="leftdiv"><img src="IMG\LOGO.png">
        <div class="leftdivbutns">
     <button onclick="location.href='#gmr'">HOME</button>
     <button onclick="location.href='#abt'">ABOUT</button>
     <button onclick="location.href='#sk'">SKILLS</a></button>
     <button onclick="location.href='#ffff'">CONTACT</button>
     <button onclick="location.href='index1.php'">CUSTOMIZE</button>
        </div>
